...
L["chatHideGuildMOTD"] = "Hide Guild Message of the Day"
L["chatHideGuildMOTDDesc"] = "Hide the system message that shows the guild's Message of the Day in the chat frame"
